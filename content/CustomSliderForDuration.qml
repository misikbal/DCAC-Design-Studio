...
Item {
    ...
    property int maximumValueEski: 1000
    property int maximumValueYeni: 1000
    ...
    Slider {
        ...
        handle: Rectangle {
            ...
            x: ((maximumValueYeni*0.21)/maximumValueEski) * slider.value - width / 2
